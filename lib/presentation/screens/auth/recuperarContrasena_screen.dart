...
class _RecuperarContrasenaScreenState extends State<RecuperarContrasenaScreen> {
  ...
  // Correo válido para recuperación
  static const String VALID_RECOVERY_EMAIL = 'brayanhuincho975@gmail.com';
  ...
  Future<void> _recuperarContrasena() async {
    ...
    if (mounted) {
      ...
      // Validar si el correo existe en la base de datos (simulación)
      if (_emailController.text.toLowerCase().trim() == VALID_RECOVERY_EMAIL) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Mensaje
                Text(
                  'El correo ${_emailController.text} no está registrado en nuestro sistema.',
                  style: TextStyle(
                    fontSize: 16,
                    color: AppTheme.mediumGray,
                  ),
